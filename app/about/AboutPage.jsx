        ...
        <div className="hero-content">
          ...
          <div className="hero-left fade-left">
            ...
            <p className="delay-1">
              ...
              ada sistem yang memastikan semuanya
              berjalan adil.

              Di balik setiap kemenangan,
              ada platform yang memberi kesempatan
              untuk bertanding.

              Semesta Esports hadir untuk mereka
              yang ingin lebih dari sekadar
              bermain— kami hadir untuk mereka
              yang ingin bersaing, berkembang,
              dan diakui.
        ...
        <div className="about-container">
          ...
          <div className="about-left fade-left">
            ...
            <p className="about-desc delay-1">
              ...
              komunitas yang menghadirkan
              turnamen esports kompetitif,
              profesional, dan terbuka untuk semua.
            </p>

            <p className="about-desc delay-2">
              Kami menjadi wadah bagi pemain
              dan tim untuk berkembang,
              menunjukkan skill, dan merasakan
              atmosfer kompetisi yang nyata.
            </p>
          ...
          <div className="about-right">
            ...
            <div className="about-card fade-up">
              ...
              <p>
                Membantu komunitas berkembang
                melalui tournament yang lebih
            ...
            <div className="about-card fade-up delay-1">
              ...
              <p>
                Menjadi platform tournament
                terbaik dengan sistem modern.
              </p>
            </div>
            ...
            <div className="about-card fade-up delay-2">
              ...
              <p>
                ...
                turnamen — kami menciptakan
                pengalaman kompetitif yang
                serius, transparan, dan
                berkesan untuk setiap pemain.
              </p>
            </div>
